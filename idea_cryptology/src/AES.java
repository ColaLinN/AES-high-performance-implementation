...
//    private byte[][] State=new byte[4][4];
    private  byte[][]  State={
    {(byte)0x00,(byte)0x01,(byte)0xda,(byte)0x86},
    {(byte)0x01,(byte)0xa1,(byte)0x78,(byte)0x15},
    {(byte)0x00,(byte)0x98,(byte)0x17,(byte)0x35},
    {(byte)0x01,(byte)0xaf,(byte)0x34,(byte)0x66}};
    //初始密钥
...
//        System.out.print("\n");
        ...
        for(int i=Nr;i>1;i--)
        {
            ...
            {
                int keyi=(i-1)*Nk+j;//用于查找需要匹配哪个key
