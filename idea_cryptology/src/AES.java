...
public class AES {
    ...
    public void encrypt(){
        ...
        System.out.println("寻址"+byteinput[0]);//寻址
        System.out.println("字节转字符串"+new String(byteinput));//字节转字符串
        ...
        for(int i=0;i<4;i++)
        {
            for(int j= 0;j<4;j++)
            {
                ...
                System.out.printf("%x",tranferbyteinput[i][j]&0xff);
            }
        }
...
//                ,{(byte)0xda,(byte)0x79,(byte)0x17,(byte)0x14},{(byte)0x60,(byte)0x15,(byte)0x35,(byte)0x94}};
    ...
    public void KeyExpansion(byte[][] originkey){
        ...
        for(int i=0;i<Nk;i++){
            ...
            System.out.printf("\n第"+i+"列："+"%2x%2x%2x%2x",inttemp[0],inttemp[1],inttemp[2],inttemp[3]);
